...
public class TrayPort {
    ...
    private void createPopup2n(TrayIcon trayIcon, SystemTray tray) throws Exception {
        ...
        IP.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
JOptionPane.showMessageDialog(null, ""+IP.getLabel());
            }
        });
    ...
    private void addChats(clientThread thread) {
        ...
        kick.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int op = JOptionPane.showConfirmDialog(null, "Do u really want to throw " + thread.clientName + " to leave the chat room?", "Confirm Kick OUT", JOptionPane.YES_NO_OPTION);
                    if (op == JOptionPane.YES_OPTION) {
                        thread.Stop();
                        JOptionPane.showMessageDialog(null, thread.clientName + " has been kicked out of the chat room.");

                    } else if (op == JOptionPane.NO_OPTION) {
                        JOptionPane.showMessageDialog(null, thread.clientName + " has not been kicked out of the chat room.");
                    }
                } catch (Exception ex) {
